...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes a starting value and performs an operation on it
    # for each item in the array.  Operations are cumulative -- 
    # the starting value does not get reset
  end
  ...
  # Answer: The former method keeps the file open in case we wish to modify it
  # Answer 2: On the contrary, the former method handles opening and closing
  # the file implicitly
